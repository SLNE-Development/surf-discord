...
//		registerAdvancedModal(UnbanTicketChannelCreationModal::new);
  ...
  public void registerAdvancedModal(String modalId,
      Supplier<DiscordStepChannelCreationModal> creator) {
   ...
   */
  private DiscordModal getModalByClass(Class<? extends DiscordModal> clazz)
    ...
    try {
      ...
      DataApi.getDataInstance()
          .logError(getClass(), "Failed to create a new instance of the modal class.",
              exception
          );
    }
    ...
    if (discordModal == null) {
      throw new IllegalArgumentException(
          "The modal class must have a constructor without parameters");
    }
