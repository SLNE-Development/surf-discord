...
/**
 * The type Discord admin discord role.
 */
public class DiscordAdminDiscordRole extends DiscordRole {

	/**
	 * Create a new discord admin role with the name "DiscordAdmin" and the
	 * following
	 * permissions:
	 * <ul>
	 * <li>VIEW_CHANNEL</li>
	 ...
	 * </ul>
	 */
	public DiscordAdminDiscordRole() {
		super(DiscordRole.DISCORD_ADMIN_ROLE, List.of(
